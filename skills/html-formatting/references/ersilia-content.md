...
- **Favicon:** the Ersilia "target" mark — plum `#50285A` ring, white band, red `#D8412F`
  centre dot — shipped as an **inline-SVG data-URI** in `assets/head.html`. No external file
  (CSP-safe). This is the default; don't reach for a raster.
