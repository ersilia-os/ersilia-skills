...
Exit codes:
- 0 on successful upload + README update; the GitHub `html_url` of the digest and the
  README are printed to stdout, one per line, so the skill can hand the user links.
